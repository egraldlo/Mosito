...
BCShuffleLowerSerObj::BCShuffleLowerSerObj(NewSchema ns, vector<int> seqs, QueryPlan* child, int exchange_id)
:ns_(ns), seqs_(seqs), child_(child), exchange_id_(exchange_id){

}

BCShuffleLowerSerObj::~BCShuffleLowerSerObj() {

}

BCShuffleLower::BCShuffleLower(vector<Expression *> expressions, QueryPlan *child) {

}

BCShuffleLower::BCShuffleLower(Sender** senders) {
	senders_=senders;
}

BCShuffleLower::~BCShuffleLower() {

}

bool BCShuffleLower::prelude() {
...
bool BCShuffleLower::execute(Block *block) {
...
void * BCShuffleLower::send_route(void *args) {
	BCShuffleLower *pthis=(BCShuffleLower *)args;
